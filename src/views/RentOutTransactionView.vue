      ...
      <div class="flex justify-between items-center px-4 py-3">
        ...
        <div class="relative">
          ...
          <div v-if="showExportMenu" class="absolute right-0 top-full mt-2 z-50">
            <!-- Dropdown Arrow -->
            <div class="w-0 h-0 border-l-8 border-r-8 border-b-8 border-transparent border-b-white absolute -top-2 right-10 z-10"></div>

            <!-- Dropdown Content -->
            <div class="w-164 bg-white rounded-2xl border border-gray-100 shadow-2xl overflow-hidden">
              <div class="p-3 space-y-2">
                <!-- CSV Option -->
                <button @click="exportData('csv')" class="w-full flex items-center gap-3 p-2 rounded-full bg-gradient-to-r from-indigo-400/40 to-indigo-600/40 text-white hover:opacity-90 transition-all duration-200 backdrop-blur-md border border-white/16">
                  <div class="w-10 h-10 bg-gray-800/24 rounded-full flex items-center justify-center border border-white stroke-white">
                  ...
                  <span class="text-base font-medium text-white">CSV</span>
                </button>

                <!-- PDF Option -->
                <button @click="exportData('pdf')" class="w-full flex items-center gap-3 p-2 rounded-full bg-gradient-to-r from-indigo-400/40 to-indigo-600/40 text-white hover:opacity-90 transition-all duration-200 backdrop-blur-md border border-white/16">
                  <div class="w-10 h-10 bg-gray-800/24 rounded-full flex items-center justify-center border border-white stroke-white">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="text-base font-medium text-white">PDF</span>
                </button>
              </div>
            </div>
          </div>
