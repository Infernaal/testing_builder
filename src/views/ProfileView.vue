<template>
  <div class="profile-view w-full h-screen bg-gradient-to-br from-[#120B81] via-[#1A1086] to-[#09074E] font-montserrat relative overflow-hidden">
    ...
    <div class="content-container h-full flex flex-col relative">
      
      <!-- Header Section with User Avatar and Info -->
      <div class="header-section pt-4 pb-6 px-4 relative z-10">
        <div class="flex items-center gap-4 mb-6">
          <!-- Menu Toggle Icon -->
          <button 
            @click="openMenu"
            class="w-12 h-12 bg-white/20 border border-white/30 rounded-full flex items-center justify-center backdrop-blur-sm transition-all hover:bg-white/30"
          >
        ...
        <!-- User Profile Card -->
        <div class="profile-header-card bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-4 mb-6">
      ...
      <!-- Menu Items Section - Centered and Scrollable -->
      <div class="menu-section flex-1 px-4 overflow-y-auto pb-32">
        <div class="space-y-4">
          <!-- Calculator -->
      ...
      <div class="bottom-section absolute bottom-0 left-0 right-0 p-4 space-y-4 bg-gradient-to-t from-[#120B81] to-transparent">
        <!-- Upgrade Section - Start Block -->
        ...
        <div class="flex items-center justify-between gap-3">
          <!-- User ID -->
          <div class="flex items-center gap-0 bg-white/30 border border-white/40 rounded-full backdrop-blur-sm">
            <div class="px-3 py-2">
