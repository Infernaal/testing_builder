<template>
  <div class="cart-page max-w-md mx-auto bg-white min-h-screen pb-24 lg:max-w-lg xl:max-w-xl">
    <!-- Content Container -->
    <div class="content-container bg-white pt-4">
      
      <!-- Cart Section -->
      <div class="cart-section px-4 mb-4 sm:px-6">
        <div class="cart-card bg-gray-50 rounded-2xl p-4 mb-4 sm:p-5 lg:p-6">
          <div class="flex flex-col items-center text-center">
            ...
            <h2 class="text-2xl font-bold text-dbd-dark mb-2">Cart</h2>
