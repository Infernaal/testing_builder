  ...
  <div class="h-screen bg-gray-100 flex flex-col font-sans overflow-hidden">
        ...
        >
          ...
          <div class="flex items-center gap-1 mb-3 flex-wrap">
            ...
            <div class="flex items-center gap-0.5 text-sm text-gray-600 font-medium">
              <span>1</span>
              <IconSvg name="forevers" :size="16" color="muted" :hover-effect="false" />
          ...
          <div class="bg-green-100 rounded-xl p-3 flex items-center justify-between">
            ...
            <button class="w-6 h-6 border border-gray-300 bg-white rounded-full flex items-center justify-center">
              <IconSvg name="info" :size="20" color="muted" :hover-effect="true" />
            </button>
          </div>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        <!-- Error Message Block (inside modal) -->
        <Transition
          name="error-message"
          enter-active-class="transition-all duration-300 ease-out"
          leave-active-class="transition-all duration-200 ease-in"
        ...
        >
          <div v-if="inputError" class="mb-4">
            <div class="bg-red-500 border border-red-600 rounded-full px-4 py-3 shadow-lg relative" style="filter: drop-shadow(4px 8px 12px rgba(255, 25, 25, 0.12));">
              <!-- Warning Icon -->
