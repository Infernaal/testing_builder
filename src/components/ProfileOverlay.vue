        ...
        <div class="relative flex-1">
          ...
          <div class="px-6 space-y-2 overflow-y-auto scroll-smooth" style="height: calc(100vh - 310px);">
            ...
            <div @click="handleMenuClick('help')" class="flex items-center gap-3 p-2 hover:bg-white/10 rounded-xl cursor-pointer transition-all">
              ...
              <span class="text-white font-bold text-sm">Help</span>
            </div>
          </div>
        </div>
...
.scroll-fade {
  ...
  -webkit-mask-image: linear-gradient(to bottom, black calc(100% - 64px), transparent);
}
