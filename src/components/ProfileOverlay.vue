        ...
        <div class="px-3 relative flex-1 overflow-hidden">
          ...
          <div class="space-y-2 overflow-y-auto scroll-smooth touch-scroll pr-2" style="height: calc(100vh - 580px); min-height: 200px; max-height: 300px;">
            ...
            <div @click="handleMenuClick('verification')" class="flex items-center gap-3 px-1.5 py-3 hover:bg-white/10 rounded-lg cursor-pointer transition-all">
              ...
              <!-- Red X Badge -->
              <div class="w-6 h-6 bg-[#FF1919] border border-[#FF1919] rounded-full flex items-center justify-center flex-shrink-0">
                <svg width="15" height="15" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M9.66675 7.33329L6.00002 3.66663L4.33337 5.33329" stroke="white" stroke-width="0.75" stroke-linecap="round"/>
                  <path d="M9.66675 5.33329C9.17675 5.33329 8.73675 5.66663 8.66675 6.33329C8.49675 7.33329 8.33337 8.66663 8.33337 9.66663" stroke="white" stroke-width="0.75" stroke-linecap="round"/>
                </svg>
              </div>
            </div>
