    ...
    <div class="flex items-center justify-center px-2 py-3 safe-area-pb">
      <div class="flex items-center gap-2 sm:gap-4 w-full max-w-sm mx-auto px-2">
        ...
        >
          ...
          <span class="text-xs font-medium font-montserrat">Profile</span>
        </button>
        ...
        >
          ...
          <span class="text-xs font-medium font-montserrat">Wallet</span>
        </button>
        ...
        >
          ...
          ]" class="text-xs font-montserrat">Favorites</span>
        </button>
        ...
        >
          ...
          <span class="text-xs font-medium font-montserrat">Cart</span>
        </button>
        ...
        >
          ...
          <span class="text-xs font-medium font-montserrat">Holders</span>
        </button>
      </div>
    </div>
  </div>
