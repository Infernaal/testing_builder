      ...
      <div class="flex items-center gap-2 sm:gap-4 w-full max-w-sm mx-auto px-2">
        ...
        >
          <div
            :class="[
              'w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center',
              activeTab === 'wallet' ? 'bg-blue-700' : ''
            ]"
          >
            <svg width="18" height="16" viewBox="0 0 20 18" :class="activeTab === 'wallet' ? 'text-white' : 'text-gray-600'" class="w-4 h-4 sm:w-5 sm:h-5">
          ...
          <span class="text-xs sm:text-sm font-medium">Wallet</span>
        </button>
        ...
        >
          <div
            :class="[
              'w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center',
              activeTab === 'cart' ? 'bg-blue-700' : ''
            ]"
          >
            <svg width="16" height="18" viewBox="0 0 18 20" :class="activeTab === 'cart' ? 'text-white' : 'text-gray-600'" class="w-4 h-4 sm:w-5 sm:h-5">
          ...
          <span class="text-xs sm:text-sm font-medium">Cart</span>
        </button>
        ...
        >
          <div
            :class="[
              'w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center',
              activeTab === 'holders' ? 'bg-blue-700' : ''
            ]"
          >
            <svg width="16" height="18" viewBox="0 0 18 20" :class="activeTab === 'holders' ? 'text-white' : 'text-gray-600'" class="w-4 h-4 sm:w-5 sm:h-5">
          ...
          <span class="text-xs sm:text-sm font-medium">Holders</span>
        </button>
      </div>
    </div>
  </div>
