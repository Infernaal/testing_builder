    ...
    >
      ...
      >
        ...
        <div class="px-4 mb-6 relative">
          ...
          >
            ...
            <div class="flex items-center min-w-0 flex-shrink-0">
              ...
              <div class="flex flex-col ml-2 min-w-0">
                ...
                <div class="text-sm font-semibold text-dbd-gray break-all" :title="calculatedDollars">
                  ${{ calculatedDollars }}
                </div>
              </div>
            </div>
          ...
          <!-- Figma Error Popup -->
          <div v-if="inputError && errorMessage" class="absolute top-full mt-2 left-4 right-4 z-10">
            <div class="relative">
              <!-- Error Popup -->
