          ...
          >
            ...
            <div class="flex items-center flex-1 min-w-0">
              ...
              <div class="flex flex-col ml-3 flex-1 min-w-0">
                <span class="text-dbd-gray text-xs font-medium">Forevers {{ selectedBalance?.code }}</span>
                <input
                  ref="inputField"
                  v-model="inputValue"
                  type="text"
                  inputmode="numeric"
                  class="text-base font-semibold text-dbd-dark bg-transparent border-none outline-none p-0 m-0 w-full telegram-input"
                  placeholder="250"
                  @input="handleInput"
            ...
            <!-- Dollar Section -->
            <div class="flex items-center min-w-0 max-w-[100px]">
              ...
              <div class="flex flex-col ml-2 flex-1 min-w-0">
                <span class="text-dbd-gray text-xs font-medium">USD</span>
                <span class="text-sm font-semibold text-dbd-gray truncate" title="{{ calculatedDollars }}">
                  {{ calculatedDollars }}
                </span>
              </div>
            </div>
