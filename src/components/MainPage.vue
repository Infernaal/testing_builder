<template>
  <div class="main-page max-w-md mx-auto bg-white min-h-screen pb-24 lg:max-w-lg xl:max-w-xl">
    <!-- Content Container -->
    <div class="content-container bg-white pt-4">

      <!-- Main Section -->
      <div class="main-section px-4 mb-4 sm:px-6">
        <div class="main-card bg-dbd-light-blue rounded-2xl p-4 mb-4 sm:p-5 lg:p-6">
          <div class="flex flex-col items-center text-center">
            <div class="w-16 h-16 bg-dbd-primary rounded-lg flex items-center justify-center mb-4">
            ...
            <h2 class="text-2xl font-bold text-dbd-dark mb-2">Main</h2>
