<template>
  ...
  >
    <div
      v-if="isVisible"
      class="fixed inset-x-0 bottom-0 bg-gradient-to-br from-indigo-900 via-blue-900 to-indigo-950 rounded-t-3xl z-50 max-w-md mx-auto"
      ...
      <div class="p-4 h-full flex flex-col">
        ...
        <div class="flex-1 space-y-3 overflow-y-auto">
          ...
          >
            ...
            <div v-if="item.badge" class="w-6 h-6 bg-red-500 border border-red-600 rounded-full flex items-center justify-center">
        ...
        <!-- Upgrade Section -->
        <div class="mt-4 p-4 bg-purple-100 border border-purple-200 rounded-xl">
