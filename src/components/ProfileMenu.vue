<template>
  ...
  <!-- Profile Menu - Exact Figma Implementation -->
  <Transition
    name="slide"
  ...
  >
    <div
      v-if="isVisible"
      class="fixed inset-x-0 bottom-0 z-50 max-w-md mx-auto"
      ...
      >
        ...
        <div class="px-3 space-y-2 flex-1 overflow-y-auto" style="height: calc(100% - 300px);">
          ...
          <div class="flex items-center gap-3 p-3 hover:bg-white/10 rounded-xl cursor-pointer">
            ...
            <!-- Red X Badge -->
            <div class="w-6 h-6 bg-red-100 border border-red-500 rounded-full flex items-center justify-center">
              <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8.5 1.5L1.5 8.5" stroke="#DC2626" stroke-width="1.5" stroke-linecap="round"/>
                <path d="M1.5 1.5L8.5 8.5" stroke="#DC2626" stroke-width="1.5" stroke-linecap="round"/>
              </svg>
            </div>
          </div>
        ...
        <div class="absolute bottom-0 left-0 right-0 p-3 space-y-3">
          <!-- Upgrade Section - ПОКАЗЫВАЕМ БЛОК START -->
          <div class="bg-purple-100 border border-purple-200 rounded-2xl p-3 relative overflow-hidden">
            <!-- Star Icon -->
            ...
            <div class="flex items-center justify-between relative z-10">
              ...
              <button class="px-6 py-2.5 bg-gradient-to-r from-dbd-primary to-blue-600 text-white font-bold rounded-full text-sm hover:shadow-lg transition-all duration-200 flex-shrink-0">
                Upgrade
              </button>
            </div>
          </div>
          ...
          <div class="flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2 px-3 py-2 bg-white/30 border border-white/40 rounded-full backdrop-blur-sm">
              ...
              <button class="ml-1 p-1 bg-white rounded-r-full border border-gray-300">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" class="text-gray-700">
